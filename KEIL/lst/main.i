...
void SYS_Init(void)
{
    ...
    CLK_SetHCLK((0x04UL<<(0)), (((1)-1) << (0)));

     
    CLK_SetModuleClock(((((1) & 0x03) << 30)|((((27)) & 0x1f) << 0)| (((3UL) & 0x03) << 28)|(((1) & 0x07) << 25)|(((8) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((4) & 0x1f) << 5)), (0x0U << (8)), (((1)-1) << (4)));
#line 52 "..\\main.c"
    ...
    CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((27)) & 0x1f) << 0)| (((3UL) & 0x03) << 28)|(((1) & 0x07) << 25)|(((8) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((4) & 0x1f) << 5)));
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->GPB_MFPL = (0x1UL<<(0)) | (0x1UL<<(4));
...
void UART0_Init(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST1 |=  (0x1ul << (16));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST1 &= ~(0x1ul << (16));

     
    ((UART_T *) (((uint32_t)0x40000000) + 0x50000))->BAUD = ((0x1ul << (29)) | (0x1ul << (28))) | ((((((48000000UL)/2)) + ((115200)/2)) / (115200))-2);
    ((UART_T *) (((uint32_t)0x40000000) + 0x50000))->LINE = (3) | (0x0 << (3)) | (0x0 << (2));
}
...
void HID_UpdateKbData(void)
{
    ...
    if (g_u8EP2Ready)
    {
        pu8Buf = (uint8_t *)(((((uint32_t)0x40000000) + 0x60000)+0x100) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[0]. BUFSEG + (uint32_t)((2) << 4)))));

         
        u32Key = (((GPIO_T *) ((((uint32_t)0x50000000) + 0x04000) + 0x00040))->PIN & (1 << 15)) ? 0 : 1;
        ...
        if (u32Key == 0)
        {
            ...
            if (u32Key != u32PreKey)
            {
                ...
                (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[0]. MXPLD + (uint32_t)((2) << 4))) = (8));
            }
        }
        else
        {
...
int32_t main(void)
{
    ...
    u32TrimInit = (*((vu32 *) (((((uint32_t)0x50000000) + 0x00000)+0x110))));

     
    (((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->INTSTS = ((0x1ul << (4))));
    ...
    while (1)
    {
        ...
        if ((((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTCTL & (0x3ul << (0))) != 0x2)
        {
             
            if (((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->INTSTS & (0x1ul << (4)))
            {
                 
                (((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->INTSTS = ((0x1ul << (4))));

                 
                ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTCTL |= ((0x1ul << (10)) | 0x2);
            }
        }

         
        if (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTISTS & ((0x1ul << (2)) | (0x1ul << (1))))
        {
             
            (*((vu32 *) (((((uint32_t)0x50000000) + 0x00000)+0x110)))) = u32TrimInit;

             
            ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTCTL = 0;

             
            ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTISTS = (0x1ul << (2)) | (0x1ul << (1));
